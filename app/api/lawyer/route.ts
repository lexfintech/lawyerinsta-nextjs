...
export async function GET(req: NextRequest) {
  ...
  try {
    const lawyer = await Lawyer.findOne({ enrollment_id: enrollmentId }).select(
      '-password_hash -_id -profile_overview -state_id -city_id -createdAt -updatedAt -__v',
    );
