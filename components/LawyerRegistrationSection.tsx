        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Create your free professional profile, reach more clients, and grow your practice 
              with LawyerInsta. Join thousands of successful lawyers who trust our platform.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700">Free professional profile creation</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="bg-[#D6A767] bg-opacity-10 p-2 rounded-full">
                  <TrendingUp className="h-5 w-5 text-[#D6A767]" />
                </div>
                <span className="text-gray-700">Reach more potential clients</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="bg-[#D6A767] bg-opacity-10 p-2 rounded-full">
                  <Shield className="h-5 w-5 text-[#D6A767]" />
                </div>
                <span className="text-gray-700">Verified and trusted platform</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="bg-[#D6A767] bg-opacity-10 p-2 rounded-full">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <div className="text-3xl font-bold text-[#D6A767] mb-2">20L+</div>
                <div className="text-sm text-gray-600">Registered Lawyers</div>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <div className="text-3xl font-bold text-[#D6A767] mb-2">1M+</div>
                <div className="text-sm text-gray-600">Client Connections</div>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <div className="text-3xl font-bold text-[#D6A767] mb-2">100+</div>
                <div className="text-sm text-gray-600">Cities Covered</div>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <div className="text-3xl font-bold text-[#D6A767] mb-2">4.8★</div>
            ...
            <div className="mt-8 p-4 bg-[#D6A767] bg-opacity-10 rounded-lg">
              <p className="text-center text-gray-700 text-sm">
                <strong>Special Offer:</strong> Register now and get 3 months of premium listing for free!
              </p>
            </div>
          </div>
        </div>
